		...
		<header className="sticky top-0 z-50 border-b border-[var(--line)] bg-[var(--header-bg)] backdrop-blur-xl">
			<nav className="page-wrap flex h-14 items-center gap-6">
				<h2 className="m-0 flex-shrink-0">
					<Link
						to="/"
						className="flex items-center gap-2 text-[15px] font-bold tracking-tight text-[var(--sea-ink)] no-underline"
					>
						<span className="btn-gradient flex size-7 items-center justify-center rounded-lg">
